 ...
 * Description: Secure REST bridge for ChatGPT Web Agent to inspect and manage WordPress pages.
 * Version: 0.1.0
...
final class ChatGPT_Web_Agent {
    ...
    public static function settings_page() {
        ...
        echo '<p>Use this token only in the control server <code>WORDPRESS_TOKEN</code> environment variable.</p>';
